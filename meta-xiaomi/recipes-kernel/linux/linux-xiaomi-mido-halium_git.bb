...
SRCREV = "6e40f09cdbe119e59082a43e4edd859a06abdac8"
...
# C23 made constexpr a keyword, and this host GCC (15.x on Ubuntu 26.04)
# defaults to -std=gnu23, so building the kernel host tools fails:
#
...
#
# Same fix as linux-xiaomi-tissot-halium and linux-google-sargo: all three are
# 4.9 trees from shr-distribution/linux, so all three hit this the moment the
# host compiler moved on. It surfaces in do_install rather than do_compile,
# because that is where headers_install rebuilds scripts/unifdef.
