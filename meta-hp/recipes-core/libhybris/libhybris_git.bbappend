...
SRC_URI_append_tenderloin = " \
    file://0001-Force-distro-wayland-instead-of-built-in.patch;patchdir=hybris \
    file://0002-include-gles3-headers.patch;patchdir=hybris \
    file://0003-add-glesv3-headers.patch;patchdir=hybris \
"
