...
for i in busybox-udhcpc dnsmasq hwclock syslog syslog.busybox shr-splash crond keymap fbsetup populate-volatile mountall bootmisc mountnfs checkroot modutils; do
